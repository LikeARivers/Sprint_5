...
class SBurgersLocators:
    PERSONAL_ACCOUNT_BUTTON_MAIN = (By.XPATH, ".//nav/a/p[text()='Личный Кабинет']") #кнопка Личный кабинет на главной странице
    BUTTON_AUTHORIZATION_MAIN = (By.XPATH, "//button[text() = 'Войти в аккаунт']")  # кнопка Войти в аккаунт на главной странице
    REGISTRATION_BUTTON = (By.XPATH, ".//main/div/div/p/a[text()='Зарегистрироваться']") #кнопка Зарегистрироваться на странице авторизации
